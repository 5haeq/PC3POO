...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{PC3 - Programaci\'on Orientada a Objetos}
\fancyhead[R]{\thepage}
...
\begin{titlepage}
    ...
    {\large \textbf{PC3 - Programaci\'on Orientada a Objetos}}\\[0.5cm]
...
El presente documento describe el dise\~no e implementaci\'on de un \textbf{prototipo acad\'emico de videoconferencia} inspirado en Zoom, desarrollado en Python como parte del curso de Programaci\'on Orientada a Objetos (PC3).
